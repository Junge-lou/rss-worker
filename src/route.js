...
import bilibili_player from './lib/bilibili/user/player';
import bilibili_stream from './lib/bilibili/user/stream';
...
let plugins = [bilibili_user_dynamic, bilibili_user_video, bilibili_player, bilibili_stream, telegram_channel, weibo_user, xiaohongshu_user];
